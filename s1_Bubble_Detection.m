...
tracker = multiObjectTracker('MaxNumTracks', 1500, 'AssignmentThreshold', 30,  'ConfirmationThreshold', [8 10], DeletionThreshold= 20);
...
for frameNum = 1:numFrames
    ...
    % Save cropped frame
    frameFileName = fullfile(outputFolder, sprintf('Cropped frame_%d.jpg', frameNum));
    imwrite(cropped_frame, frameFileName);
